<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Admin_Create_Edit_Employee.aspx.cs" Inherits="Pages_Admin_Create_Employee"  MasterPageFile="~/ShoppingCart.master"%>

<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<form id="Form1" runat="server" action="Register.aspx"  >
<asp:Panel ID="Panel1" runat="server" Height="200" Width="500"><center><h1 >Create Employee</h1></center>
